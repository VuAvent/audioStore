...
<body>
	...
	<div class="single" style="padding-top: 15px">
		<div class="wrap">

			<div class="content-bottom">
				<c:forEach items="${itemSearch1}" var="item">

					<div class="box1">

						<div class="col_1_of_3 span_1_of_3" style="margin-right: 30px">
									...
									<li><img src="resource/images/plus.png" alt="" />
										<ul class="icon1 sub-icon1 profile_img">
											<li><a class="active-icon c1"
												href="addtoCart?id=${item.id}">Add To Bag </a></li>
										</ul></li>
								</ul>
							</a>
						</div>
